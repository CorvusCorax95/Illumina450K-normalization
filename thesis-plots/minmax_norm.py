...
fig.suptitle("Minmax Normalizations")
...
sample_list = df_minmax_beta_t1.columns.values.tolist()[1:]

for sample in sample_list:
	sns.kdeplot(df_minmax_beta_t1[sample], color=light_blue, ax=ax[0])
	sns.kdeplot(df_minmax_beta_t2[sample], color=light_purple, ax=ax[1])

df_minmax_beta_t1['Median'] = df_minmax_beta_t1.median(axis=1)
df_minmax_beta_t2['Median'] = df_minmax_beta_t2.median(axis=1)

sns.kdeplot(df_minmax_beta_t1['Median'], color=dark_blue, ax=ax[0])
sns.kdeplot(df_minmax_beta_t2['Median'], color=dark_purple, ax=ax[1])
